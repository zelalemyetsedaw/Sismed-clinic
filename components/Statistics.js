...
const Statistics = () => {
  return (
    <div
        style={{
          backgroundImage:
            "linear-gradient( rgba(0, 0, 0, 0.3), rgba(0, 0, 0, 0.3) ),url('https://nyihr.com/wp-content/uploads/care-plus-16.jpg')",
      ...
      >
        <div className="bg-[#428CF4] md:flex lg:py-10 py-0  h-full opacity-80 ">
          <div className="md:w-1/2 w-full flex flex-col self-center text-left gap-y-6 text-white pl-5  md:pl-20 ">
            <div>
            ...
            <div>
              <button className="p-4 w-4/5 md:w-full  rounded-full bg-[#FE5F55] ">
                {" "}
                Make an Appointment{" "}
              </button>
            </div>
          ...
          <div className="flex w-full md:w-1/2  flex-wrap py-10 md:p-5 lg:p-10">
            <div className="w-full md:w-1/2 md:py-0 py-10 flex flex-col items-center justify-center text-white border-b-2 md:border-r-2 h-1/2">
              <h1 className="text-7xl font-extrabold"> 30 </h1>
